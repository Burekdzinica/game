all:
	...
	g++ -I src/include -L src/lib -o main main.cpp -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lSDL2_ttf -g -static-libgcc -static-libstdc++
	g++ -I src/include -L src/lib -o main main.cpp -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lSDL2_ttf -lwinpthread -g -static-libgcc -static-libstdc++ -lpthread -lSDL2_mixer
